...
/***/ "./resources/js/admin/pages/page/AddItem/index.js":
/*!********************************************************!*\
  !*** ./resources/js/admin/pages/page/AddItem/index.js ***!
  \********************************************************/
...
/* harmony import */ var _components_AppTextEditor___WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../components/AppTextEditor/ */ "./resources/js/admin/components/AppTextEditor/index.js");
/* harmony import */ var _services_PageService__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../services/PageService */ "./resources/js/admin/services/PageService.js");
/* harmony import */ var _services_CategoryService__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../../services/CategoryService */ "./resources/js/admin/services/CategoryService.js");
...
var AddItem = function AddItem(_ref) {
  ...
  var validationSchema = yup__WEBPACK_IMPORTED_MODULE_9__["object"]({
    title: yup__WEBPACK_IMPORTED_MODULE_9__["string"]().required(String(messages["validation.nameRequired"]))
  });
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return _services_PageService__WEBPACK_IMPORTED_MODULE_19__["default"].createItem(reqData).then(function (response) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    if (isOpen) {
      _services_CategoryService__WEBPACK_IMPORTED_MODULE_20__["default"].listItem({
        entity_type: 'page'
      }).then(function (result) {
        setCategoryList(_toConsumableArray(result.data.data));
      });
    }
  }, [isOpen]);
  ...
  , {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(formik__WEBPACK_IMPORTED_MODULE_8__["Form"], {
      ...
      xs: 12,
      md: 12
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_components_AppTextEditor___WEBPACK_IMPORTED_MODULE_18__["default"], {
      name: "content",
      label: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_crema_utility_IntlMessages__WEBPACK_IMPORTED_MODULE_15__["default"], {
        id: "common.content"
      }),
...
/***/ "./resources/js/admin/pages/page/ItemDetails/index.js":
/*!************************************************************!*\
  !*** ./resources/js/admin/pages/page/ItemDetails/index.js ***!
  \************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/admin/pages/page/ListItems/index.js":
/*!**********************************************************!*\
  !*** ./resources/js/admin/pages/page/ListItems/index.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _services_PageService__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../services/PageService */ "./resources/js/admin/services/PageService.js");
/* harmony import */ var _UpdateItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../UpdateItem */ "./resources/js/admin/pages/page/UpdateItem/index.js");
...
/* harmony import */ var _ItemDetails__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../ItemDetails */ "./resources/js/admin/pages/page/ItemDetails/index.js");
...
var ListItems = function ListItems(_ref) {
  ...
  var deleteItem = function deleteItem() {
    ...
    _services_PageService__WEBPACK_IMPORTED_MODULE_5__["default"].deleteItem(item['uuid']).then(function (response) {
      handleRefreshGrid();
  ...
  var changeStatus = function changeStatus(status) {
    dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_8__["fetchStart"])());
    _services_PageService__WEBPACK_IMPORTED_MODULE_5__["default"].updateItem(item['uuid'], {
  ...
  var handleUpdateStatusChange = function handleUpdateStatusChange(event, item) {
    ...
    dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_8__["fetchStart"])());
    _services_PageService__WEBPACK_IMPORTED_MODULE_5__["default"].updateItem(item.uuid, data).then(function (response) {
      dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_8__["fetchSuccess"])());
      dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_8__["showMessage"])(response.message));
      handleRefreshGrid();
    })["catch"](function (error) {
  ...
  var listItems = function listItems(props) {
    ...
    setLoading(true);
    return _services_PageService__WEBPACK_IMPORTED_MODULE_5__["default"].listItem(reqData).then(function (response) {
      setLoading(false);
      var data = [];
      var count = 0;
  ...
  var columns = [{
    name: 'title',
    header: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("b", null, "Title"),
    defaultFlex: 1,
...
/***/ "./resources/js/admin/pages/page/ManageItems.js":
/*!******************************************************!*\
  !*** ./resources/js/admin/pages/page/ManageItems.js ***!
  \******************************************************/
/*! exports provided: default */
...
/* harmony import */ var _ListItems__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ListItems */ "./resources/js/admin/pages/page/ListItems/index.js");
/* harmony import */ var _AddItem__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./AddItem */ "./resources/js/admin/pages/page/AddItem/index.js");
...
/***/ "./resources/js/admin/pages/page/UpdateItem/index.js":
/*!***********************************************************!*\
  !*** ./resources/js/admin/pages/page/UpdateItem/index.js ***!
  \***********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _crema_core_AppFormComponents_AppTextField__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../@crema/core/AppFormComponents/AppTextField */ "./resources/js/admin/@crema/core/AppFormComponents/AppTextField.js");
/* harmony import */ var _crema_core_AppFormComponents_AppAutocompleteField__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../@crema/core/AppFormComponents/AppAutocompleteField */ "./resources/js/admin/@crema/core/AppFormComponents/AppAutocompleteField.js");
/* harmony import */ var _services_PageService__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../services/PageService */ "./resources/js/admin/services/PageService.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var UpdateItem = function UpdateItem(_ref) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])([]),
    _useState2 = _slicedToArray(_useState, 2),
    parentList = _useState2[0],
    setParentList = _useState2[1];
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])([]),
    _useState4 = _slicedToArray(_useState3, 2),
    entityTypeList = _useState4[0],
    setEntityTypeList = _useState4[1];
  var action = function action() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_mui_material_Button__WEBPACK_IMPORTED_MODULE_1__["default"], {
      onClick: function onClick() {
        return handleOpen(false);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return _services_PageService__WEBPACK_IMPORTED_MODULE_18__["default"].updateItem(reqData.uuid, reqData).then(function (response) {
              dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_12__["fetchSuccess"])());
              dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_12__["showMessage"])(response.message));
              handleOpen(true);
            })["catch"](function (error) {
...
/***/ "./resources/js/admin/services/PageService.js":
/*!****************************************************!*\
  !*** ./resources/js/admin/services/PageService.js ***!
  \****************************************************/
...
var createItem = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(reqData) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          return _context.abrupt("return", _crema_services_auth_jwt_auth__WEBPACK_IMPORTED_MODULE_0__["default"].post('/admin/pages', reqData).then(_ResponseService__WEBPACK_IMPORTED_MODULE_1__["default"].handleSuccessResponse)["catch"](_ResponseService__WEBPACK_IMPORTED_MODULE_1__["default"].handleErrorResponse));
        case 1:
        case "end":
          return _context.stop();
      }
...
var updateItem = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(uuid, reqData) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          return _context2.abrupt("return", _crema_services_auth_jwt_auth__WEBPACK_IMPORTED_MODULE_0__["default"].patch("/admin/pages/".concat(uuid), reqData).then(_ResponseService__WEBPACK_IMPORTED_MODULE_1__["default"].handleSuccessResponse)["catch"](_ResponseService__WEBPACK_IMPORTED_MODULE_1__["default"].handleErrorResponse));
        case 1:
        case "end":
          return _context2.stop();
      }
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(uuid) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          return _context3.abrupt("return", _crema_services_auth_jwt_auth__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"]("/admin/pages/".concat(uuid)).then(_ResponseService__WEBPACK_IMPORTED_MODULE_1__["default"].handleSuccessResponse)["catch"](_ResponseService__WEBPACK_IMPORTED_MODULE_1__["default"].handleErrorResponse));
        case 1:
        case "end":
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(uuid) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          return _context4.abrupt("return", _crema_services_auth_jwt_auth__WEBPACK_IMPORTED_MODULE_0__["default"].get("/admin/pages/".concat(uuid)).then(_ResponseService__WEBPACK_IMPORTED_MODULE_1__["default"].handleSuccessResponse)["catch"](_ResponseService__WEBPACK_IMPORTED_MODULE_1__["default"].handleErrorResponse));
        case 1:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          return _context5.abrupt("return", _crema_services_auth_jwt_auth__WEBPACK_IMPORTED_MODULE_0__["default"].get("/admin/pages", {
            params: reqData
...
/* harmony default export */ __webpack_exports__["default"] = (PageService);
