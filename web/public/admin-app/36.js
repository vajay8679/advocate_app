...
/***/ "./resources/js/admin/pages/category/AddItem/index.js":
/*!************************************************************!*\
  !*** ./resources/js/admin/pages/category/AddItem/index.js ***!
  \************************************************************/
...
/* harmony import */ var _services_CategoryService__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../services/CategoryService */ "./resources/js/admin/services/CategoryService.js");
/* harmony import */ var _services_EntityTypeService__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../../services/EntityTypeService */ "./resources/js/admin/services/EntityTypeService.js");
...
var AddItem = function AddItem(_ref) {
  ...
  var validationSchema = yup__WEBPACK_IMPORTED_MODULE_9__["object"]({
    name: yup__WEBPACK_IMPORTED_MODULE_9__["string"]().required(String(messages["validation.nameRequired"])),
    entity_type: yup__WEBPACK_IMPORTED_MODULE_9__["string"]().required(String(messages["validation.entityTypeRequired"]))
  });
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return _services_CategoryService__WEBPACK_IMPORTED_MODULE_18__["default"].createItem(reqData).then(function (response) {
  ...
  var fetchEntityTypeList = function fetchEntityTypeList() {
    _services_EntityTypeService__WEBPACK_IMPORTED_MODULE_19__["default"].listItem().then(function (result) {
      setEntityTypeList([{
        entity_type: '',
        entity_name: 'Select All'
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    if (isOpen) {
      ...
      _services_CategoryService__WEBPACK_IMPORTED_MODULE_18__["default"].listItem({
        entity_type: entity_type
      }).then(function (response) {
        console.log('response', response);
        if (response.data && response.data.data) {
          var items = _toConsumableArray(response.data.data);
          setParentList(items);
        }
      })["catch"](function (error) {
  ...
  , {
    ...
    })), (entity_type === null || entity_type === '') && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_mui_material_Grid__WEBPACK_IMPORTED_MODULE_0__["default"], {
      item: true,
      xs: 12,
      md: 12
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_crema_core_AppFormComponents_AppAutocompleteField__WEBPACK_IMPORTED_MODULE_17__["default"], {
...
/***/ "./resources/js/admin/pages/category/ItemDetails/index.js":
/*!****************************************************************!*\
  !*** ./resources/js/admin/pages/category/ItemDetails/index.js ***!
  \****************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/admin/pages/category/ListItems/index.js":
/*!**************************************************************!*\
  !*** ./resources/js/admin/pages/category/ListItems/index.js ***!
  \**************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _services_CategoryService__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../services/CategoryService */ "./resources/js/admin/services/CategoryService.js");
/* harmony import */ var _UpdateItem__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../UpdateItem */ "./resources/js/admin/pages/category/UpdateItem/index.js");
...
/* harmony import */ var _ItemDetails__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../ItemDetails */ "./resources/js/admin/pages/category/ItemDetails/index.js");
...
var ListItems = function ListItems(_ref) {
  var _ref$refresh = _ref.refresh,
    ...
    _ref$entity_type = _ref.entity_type,
  ...
  var deleteItem = function deleteItem() {
    ...
    _services_CategoryService__WEBPACK_IMPORTED_MODULE_5__["default"].deleteItem(item['uuid']).then(function (response) {
      handleRefreshGrid();
  ...
  var changeStatus = function changeStatus(status) {
    dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_8__["fetchStart"])());
    _services_CategoryService__WEBPACK_IMPORTED_MODULE_5__["default"].updateItem(item['uuid'], {
  ...
  var handleUpdateStatusChange = function handleUpdateStatusChange(event, item) {
    ...
    dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_8__["fetchStart"])());
    _services_CategoryService__WEBPACK_IMPORTED_MODULE_5__["default"].updateItem(item.uuid, data).then(function (response) {
      dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_8__["fetchSuccess"])());
      dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_8__["showMessage"])(response.message));
      handleRefreshGrid();
    })["catch"](function (error) {
  ...
  var listItems = function listItems(props) {
    ...
    setLoading(true);
    return _services_CategoryService__WEBPACK_IMPORTED_MODULE_5__["default"].listItem(reqData).then(function (response) {
      setLoading(false);
      var data = [];
      var count = 0;
      if (response.data && response.data.data) {
  ...
  var columns = [{
    name: 'name',
    header: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement("b", null, "Name"),
    defaultFlex: 1,
...
/***/ "./resources/js/admin/pages/category/ManageItems.js":
/*!**********************************************************!*\
  !*** ./resources/js/admin/pages/category/ManageItems.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _ListItems__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ListItems */ "./resources/js/admin/pages/category/ListItems/index.js");
/* harmony import */ var _AddItem__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./AddItem */ "./resources/js/admin/pages/category/AddItem/index.js");
...
var ManageItems = function ManageItems(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_3___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_crema_core_AppComponentHeader__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ...
    description: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_crema_utility_IntlMessages__WEBPACK_IMPORTED_MODULE_4__["default"], {
      id: "common.category.description"
    }),
    action: action()
...
/***/ "./resources/js/admin/pages/category/UpdateItem/index.js":
/*!***************************************************************!*\
  !*** ./resources/js/admin/pages/category/UpdateItem/index.js ***!
  \***************************************************************/
/*! exports provided: default */
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return _services_CategoryService__WEBPACK_IMPORTED_MODULE_18__["default"].updateItem(reqData.uuid, reqData).then(function (response) {
              dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_12__["fetchSuccess"])());
              dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_12__["showMessage"])(response.message));
              handleOpen(true);
            })["catch"](function (error) {
...
/***/ "./resources/js/admin/services/EntityTypeService.js":
/*!**********************************************************!*\
  !*** ./resources/js/admin/services/EntityTypeService.js ***!
  \**********************************************************/
...
var listItem = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          reqData = _args.length > 0 && _args[0] !== undefined ? _args[0] : {};
          return _context.abrupt("return", _crema_services_auth_jwt_auth__WEBPACK_IMPORTED_MODULE_0__["default"].get("/admin/entity-type", {
            params: reqData
...
/* harmony default export */ __webpack_exports__["default"] = (EntityTypeService);
