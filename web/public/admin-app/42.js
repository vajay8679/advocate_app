...
/***/ "./resources/js/admin/pages/bank/AddItem/index.js":
/*!********************************************************!*\
  !*** ./resources/js/admin/pages/bank/AddItem/index.js ***!
  \********************************************************/
...
var AddItem = function AddItem(_ref) {
  ...
  var validationSchema = yup__WEBPACK_IMPORTED_MODULE_9__["object"]({
    bank_name: yup__WEBPACK_IMPORTED_MODULE_9__["string"]().required(String(messages["validation.nameRequired"]))
  });
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return _services_BankService__WEBPACK_IMPORTED_MODULE_19__["default"].createItem(reqData).then(function (response) {
...
/***/ "./resources/js/admin/pages/bank/ItemDetails/index.js":
/*!************************************************************!*\
  !*** ./resources/js/admin/pages/bank/ItemDetails/index.js ***!
  \************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/admin/pages/bank/ListItems/index.js":
/*!**********************************************************!*\
  !*** ./resources/js/admin/pages/bank/ListItems/index.js ***!
  \**********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _services_BankService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../services/BankService */ "./resources/js/admin/services/BankService.js");
/* harmony import */ var _UpdateItem__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../UpdateItem */ "./resources/js/admin/pages/bank/UpdateItem/index.js");
...
/* harmony import */ var _ItemDetails__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../ItemDetails */ "./resources/js/admin/pages/bank/ItemDetails/index.js");
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
...
var ListItems = function ListItems(_ref) {
  ...
  var deleteItem = function deleteItem() {
    ...
    _services_BankService__WEBPACK_IMPORTED_MODULE_2__["default"].deleteItem(item['uuid']).then(function (response) {
      handleRefreshGrid();
  ...
  var listItems = function listItems(props) {
    ...
    setLoading(true);
    return _services_BankService__WEBPACK_IMPORTED_MODULE_2__["default"].listItem(reqData).then(function (response) {
      setLoading(false);
      var data = [];
      var count = 0;
  ...
  var columns = [{
    name: 'bank_name',
    header: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("b", null, "Bank Name"),
    defaultFlex: 1,
...
/***/ "./resources/js/admin/pages/bank/ManageItems.js":
/*!******************************************************!*\
  !*** ./resources/js/admin/pages/bank/ManageItems.js ***!
  \******************************************************/
/*! exports provided: default */
...
/* harmony import */ var _ListItems__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ListItems */ "./resources/js/admin/pages/bank/ListItems/index.js");
/* harmony import */ var _AddItem__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./AddItem */ "./resources/js/admin/pages/bank/AddItem/index.js");
...
/***/ "./resources/js/admin/pages/bank/UpdateItem/index.js":
/*!***********************************************************!*\
  !*** ./resources/js/admin/pages/bank/UpdateItem/index.js ***!
  \***********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _crema_core_AppFormComponents_AppTextField__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../@crema/core/AppFormComponents/AppTextField */ "./resources/js/admin/@crema/core/AppFormComponents/AppTextField.js");
/* harmony import */ var _crema_core_AppFormComponents_AppAutocompleteField__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../@crema/core/AppFormComponents/AppAutocompleteField */ "./resources/js/admin/@crema/core/AppFormComponents/AppAutocompleteField.js");
/* harmony import */ var _services_BankService__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../../services/BankService */ "./resources/js/admin/services/BankService.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return _services_BankService__WEBPACK_IMPORTED_MODULE_18__["default"].updateItem(reqData.uuid, reqData).then(function (response) {
              dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_12__["fetchSuccess"])());
              dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_12__["showMessage"])(response.message));
              handleOpen(true);
            })["catch"](function (error) {
