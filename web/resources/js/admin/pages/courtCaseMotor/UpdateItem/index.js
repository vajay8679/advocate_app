...
const UpdateItem = ({isOpen, handleOpen, values}) => {
  ...
  const validationSchema = yup.object({
    ...
    injury: yup.string().required(String(messages["validation.fieldRequired"])),
    ...
    company_advocate: yup.string().required(String(messages["validation.fieldRequired"])),
    remark: yup.string().required(String(messages["validation.fieldRequired"])),
    investigation: yup.string().required(String(messages["validation.fieldRequired"])),
  });
